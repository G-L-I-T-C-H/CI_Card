...
import DemoImage from "/Users/sanjith/Desktop/projects/web/CP/clgproject/assets/demo.jpg";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faCalendarDays,faHeart,faPeopleGroup, faCalendarXmark,faIndianRupeeSign,faLocationDot,faBuilding } from '@fortawesome/free-solid-svg-icons'
...
function Card(props){
    ...
    return(
    <>
    <section className="grid gap-8 rounded-xl border border-black m-2  hover:shadow-2xl md:m-5">
    <div>
        <div className="flex mt-1 space-around">
            <div className="w-[20%] h-[15%]">
                <img className="object-cover w-full" src={DemoImage} alt="competition ¸banner" />
            </div>
            ...
            <div className="flex flex-col ">
                <div className="p-5">
                    <div>
                        <nav>
                            <h1 className="font-bold text-md md:text-3xl md:mb-5" onClick={modalHandler}>{props.name}</h1>
                        </nav>
                    </div>
        ...
        <div className="px-3 ">
                <div className="flex flex-grow">
                    ...
                    <div className="flex ml-auto hover:shadow-xl md:w-1/3">
                            <button className="border border-2 rounded-lg p-1 w-full text-white bg-black bg-blue-500 ml-auto justify-end">Register</button>
                    </div>
    ...
    <Modal isVisible={showModel} onClose={()=> setshowModal(false)} name={props.name} size={props.size} deadline={props.deadline} fees={props.fees} overview={props.overview} organiser={props.organiser} number={props.number} src={props.src}/>
    </>
    )
